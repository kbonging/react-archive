...
const UserModal = ({ onClose, onAdd }) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (!name || !username || !email || !city || !company) return;
  ...
  <div className="bg-white rounded-2xl shadow-xl w-[90%] max-w-md p-6">
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="flex justify-end gap-2 pt-2">
        <button type="button" onClick={onClose} className="px-4 py-2 border rounded hover:bg-gray-100">취소</button>
